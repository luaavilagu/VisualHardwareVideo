...
void main() {
  ...
  vec4 sum = (1.0/256.0) * (col0*16.0 + col1*24.0 + col2*16*0 + col3*24.0 + col4*(36.0) + col5*24.0 + col6*16.0 + col7*24.0 + col8*16.0 + col9 + col10 + col11 + col12 + col13*4.0 + col14*6.0 + col15*4.0 + col16*4.0 + col17*6.0 + col18*4.0 + col19*4.0 + col20*6.0 + col21*4.0 + col22*4.0 + col23*6.0 + col24*4.0);
